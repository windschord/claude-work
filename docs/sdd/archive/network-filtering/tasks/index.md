...
|---------|---------|------|--------|------|
| Phase 5: Proxy基盤構築 | 3 | 3 | 0 | 0 |
| Phase 6: Proxy統合 | 3 | 3 | 0 | 0 |
| Phase 7: デフォルトルール自動適用 | 1 | 1 | 0 | 0 |
| **合計** | **7** | **7** | **0** | **0** |
...
| TASK-014 | NetworkFilterServiceのDNS解決機能削除 | DONE | なし | 20min | [詳細](phase-5/TASK-014.md) @phase-5/TASK-014.md |
| TASK-015 | docker-compose.ymlにproxyサービスとinternalネットワーク追加 | DONE | なし | 20min | [詳細](phase-5/TASK-015.md) @phase-5/TASK-015.md |

### Phase 6: Proxy統合

| ID | タイトル | ステータス | 依存 | 推定工数 | 詳細 |
|----|---------|-----------|------|---------|------|
| TASK-016 | DockerAdapterのフィルタリング統合 | DONE | TASK-013 | 40min | [詳細](phase-6/TASK-016.md) @phase-6/TASK-016.md |
| TASK-017 | ルール変更時のproxy同期（API層） | DONE | TASK-013, TASK-016 | 40min | [詳細](phase-6/TASK-017.md) @phase-6/TASK-017.md |
| TASK-018 | 通信テスト機能のproxy稼働状態確認統合 | DONE | TASK-013, TASK-014 | 30min | [詳細](phase-6/TASK-018.md) @phase-6/TASK-018.md |

### Phase 7: デフォルトルール自動適用

| ID | タイトル | ステータス | 依存 | 推定工数 | 詳細 |
|----|---------|-----------|------|---------|------|
| TASK-019 | Docker環境作成時のデフォルトネットワークフィルタリング自動適用 | DONE | なし | 20min | [詳細](phase-7/TASK-019.md) @phase-7/TASK-019.md |
...
以下のupstream Issueは [v0.1.0-rc.2](https://github.com/windschord/network-filter-proxy/releases/tag/v0.1.0-rc.2) で対応済み:

- [x] [network-filter-proxy #5](https://github.com/windschord/network-filter-proxy/issues/5): API_BIND_ADDR環境変数
- [x] [network-filter-proxy #6](https://github.com/windschord/network-filter-proxy/issues/6): healthcheckサブコマンド
...
| REQ-009 | Docker環境作成時デフォルトルール自動適用 | TASK-019 | 新規対応 |
