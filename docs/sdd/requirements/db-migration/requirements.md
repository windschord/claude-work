...
Docker ComposeでデプロイされるClaudeWorkにおいて、スキーマ変更時に既存DBを自動的にマイグレーションする機能を実装する。
...
### NFR-001: Docker Compose互換性

> システムは Docker Compose での実行環境で正常に動作しなければならない
...
| NFR-001 | Docker Compose環境で正常に動作する |
