...
| ID | タイトル | ステータス | 依存 | 推定工数 | 詳細 |
|----|---------|-----------|------|---------|------|
| TASK-004 | DNS解決とルール変換ロジックの実装 | IN_PROGRESS | TASK-003 | 40min | [詳細](phase-2/TASK-004.md) @phase-2/TASK-004.md |
| TASK-005 | フィルタリング適用・クリーンアップの実装 | TODO | TASK-002, TASK-004 | 40min | [詳細](phase-2/TASK-005.md) @phase-2/TASK-005.md |
...
| ID | タイトル | ステータス | 依存 | 推定工数 | 詳細 |
|----|---------|-----------|------|---------|------|
| TASK-007 | REST APIエンドポイント（ルールCRUD） | TODO | TASK-003 | 40min | [詳細](phase-3/TASK-007.md) @phase-3/TASK-007.md |
| TASK-008 | REST APIエンドポイント（設定・テンプレート・テスト） | TODO | TASK-004 | 40min | [詳細](phase-3/TASK-008.md) @phase-3/TASK-008.md |
