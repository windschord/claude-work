...
|----|---------|-----------|--------|-------------|------|
| TASK-001 | スキーマ検証機能の実装 | TODO | P1 | `src/lib/schema-check.ts` | [詳細](TASK-001.md) @TASK-001.md |
| TASK-002 | スキーマ同期機能の実装 | TODO | P0 | `src/bin/cli-utils.ts` | [詳細](TASK-002.md) @TASK-002.md |
| TASK-003 | ヘルスチェックAPI実装 | TODO | P3 | `src/app/api/health/route.ts` | [詳細](TASK-003.md) @TASK-003.md |
