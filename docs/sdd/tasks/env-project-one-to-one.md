...
| ID | タスク名 | ステータス | 依存 |
|---|---|---|---|
| TASK-001 | スキーマ変更: executionEnvironments に project_id 追加 | TODO | なし |
| TASK-002 | マイグレーションスクリプト作成 | TODO | TASK-001 |
| TASK-003 | スキーマ変更: projects/sessions の制約更新・カラム削除 | TODO | TASK-002 |
| TASK-004 | environment-service.ts の拡張 | TODO | TASK-003 |
| TASK-005 | 新規API: /api/projects/[project_id]/environment/* | TODO | TASK-004 |
| TASK-006 | 既存API変更: プロジェクト作成時の環境自動作成 | TODO | TASK-004 |
| TASK-007 | 既存API変更: セッション作成 API の environment_id 廃止 | TODO | TASK-003 |
| TASK-008 | WebSocketハンドラの環境参照をプロジェクト経由に変更 | TODO | TASK-003 |
| TASK-009 | 旧環境 API の廃止（410 Gone）| TODO | TASK-005 |
