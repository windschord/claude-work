...
| [npx GitHub統合](npx-github/tasks.md) | GitHub Actionsでのnpx実行対応（廃止: Docker Compose移行済み） |
| [npx Prisma修正](npx-prisma-fix/tasks.md) | Prisma実行時のnpx問題修正（廃止: Docker Compose移行済み） |
...
| [systemdセットアップ](systemd-setup/tasks.md) | systemdによるサービス化（廃止: Docker Compose移行済み） |
