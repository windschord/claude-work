...
**受入基準**:
- [ ] `/` にアクセスすると `/docker` と同じUIが表示される
- [ ] ProjectList コンポーネントが使用されていない
- [ ] ビルドが成功する
...
**受入基準**:
- [ ] `src/app/projects/` が削除されている
- [ ] `src/app/sessions/` が削除されている
- [ ] ビルドが成功する
...
**受入基準**:
- [ ] `src/components/projects/` が削除されている
- [ ] `src/components/layout/MainLayout.tsx` が削除されている
- [ ] `src/components/layout/Sidebar.tsx` が削除されている
- [ ] ビルドが成功する
