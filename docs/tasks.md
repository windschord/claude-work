...
**受入基準**:
- [x] `src/app/api/sessions/[id]/pr/route.ts`ファイルが作成されている
- [x] POSTハンドラが実装されている
- [x] セッション認証が実装されている
- [x] ghコマンドでPRが作成される
- [x] PR URLが正しく抽出される
...
**受入基準**:
- [x] `src/components/git/CreatePRButton.tsx`ファイルが作成されている
- [x] ボタンクリックでAPIを呼び出す
- [x] ローディング状態が表示される
- [x] 成功時にリンク付きトーストが表示される
- [x] リンクをクリックで新しいタブでPRページが開く
- [x] 失敗時にエラートーストが表示される
- [x] テストが作成されている（6件）
...
**受入基準**:
- [x] Diffタブ内に「PR作成」ボタンが表示される
- [x] ボタンが他のGit操作ボタンと同じ行に配置される
- [x] 視覚的に一貫したスタイリングである（紫色のボタン）
...
- [x] タスク36.1が完了している（APIエンドポイント）
- [x] タスク36.2が完了している（ボタンコンポーネント）
- [x] タスク36.3が完了している（UI配置）
- [x] Diffタブに「PR作成」ボタンが表示される
- [x] ボタンクリックでPRが作成される
- [x] 成功時にリンク付きトースト通知が表示される
- [x] リンククリックで新しいタブでPRページが開く
- [x] エラー時にエラーメッセージが表示される
- [x] すべてのテストが通過している（13件）
