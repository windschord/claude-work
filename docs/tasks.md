...
- [ ] 「設定」クリックでProjectSettingsModalが開く
- [ ] 「削除」クリックでDeleteConfirmDialogが開く
- [ ] 削除確認後にAPIが呼ばれる
- [ ] 削除成功後に一覧が更新される
...
- [ ] ホバー時にゴミ箱アイコンが表示される
- [ ] 非ホバー時はアイコンが非表示
- [ ] アイコンクリックでDeleteConfirmDialogが開く
- [ ] 削除確認後にAPIが呼ばれる
- [ ] 削除成功後に一覧が更新される
...
- [ ] PRがある場合にPR番号が表示される
- [ ] PRがない場合は何も表示されない
- [ ] ステータスに応じて色が変わる（open=緑、merged=紫、closed=赤）
- [ ] クリックでGitHubページが新規タブで開く
- [ ] セッションノードのクリックとは独立して動作する
