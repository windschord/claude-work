...
**2.2 RunScriptManagerテストの実行とパス確認**
...
**3.1 POST /api/sessions/{id}/run の実装**
...
**3.2 POST /api/sessions/{id}/run/{run_id}/stop の実装**
...
**1.2 GitServiceのresetメソッドのテスト作成**
