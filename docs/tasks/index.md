...
| ID | タスク | ステータス | 依存 | 工数 | リンク |
|----|-------|----------|------|------|--------|
| TASK-006 | PTYSessionManagerの基本構造作成 | TODO | TASK-005 | 60分 | [詳細](phase-2/TASK-006.md) @phase-2/TASK-006.md |
...
| ID | タスク | ステータス | 依存 | 工数 | リンク |
|----|-------|----------|------|------|--------|
| TASK-012 | DockerAdapterのコンテナ起動待機実装 | TODO | TASK-005 | 60分 | [詳細](phase-3/TASK-012.md) @phase-3/TASK-012.md |
