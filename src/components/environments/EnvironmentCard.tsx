    ...
    >
      ...
      <div className="flex gap-2">
        <button
          type="button"
          onClick={handleEdit}
          className="flex-1 bg-gray-600 dark:bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
